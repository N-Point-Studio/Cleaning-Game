...
public class Clean : MonoBehaviour
{
    ...
    // private void CreateTexture()
    // {
    //     _dirtRT = new RenderTexture(_dirtMaskBase.width, _dirtMaskBase.height, 0, RenderTextureFormat.ARGB32);
    //     Graphics.Blit(_dirtMaskBase, _dirtRT); // Copy initial dirt

    //     _material.SetTexture("_DirtMask", _dirtRT);
    // }
